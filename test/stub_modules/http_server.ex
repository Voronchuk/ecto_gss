defmodule EctoGSS.StubModules.HttpServer do
  @moduledoc """
  Minimal `Plug.Cowboy` stub server used by `EctoGSS.RepoStubTest` to exercise the
  full request pipeline (`GSS.Spreadsheet -> Client -> Limiter -> Request -> Finch`)
  against localhost, driven from the `EctoGSS.Repo` side.
